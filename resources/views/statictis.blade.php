        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
         <form action="" method="GET" class="form-inline" role="form">
          <div class="form-group">
            ...
            <select class="form-control" size="1" name="job_id" id="jobid" aria-controls="dynamic-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span>{{$ds->purpose}}</span>
                <?= $ds->source==1 ? '<br><span style="color:red; font-weight: bold; display: block; text-align: center;">Affiliate Tracking</span>' : '';?>
              </td>
...
<script type="text/javascript">
  jQuery(document).ready(function($) {
    ...
    $("#jobid").change(function(event){
      ...
      $.ajax({
        url: 'user/searchwithjobStatictis/',
        type:"GET", 
        cache:false,
        data: {
          "key": valuejob,
